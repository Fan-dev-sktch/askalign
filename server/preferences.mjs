...
export function policyFor(input) {
  ...
  const instructions = [
    ...
    'Whenever the user needs to choose among concrete names, styles, feature directions, priorities or approaches, proactively use a choice card instead of a prose list ending in which do you prefer. This presentation rule applies at every intensity; do not invent unnecessary decisions or force compatible goals into single choice.',
